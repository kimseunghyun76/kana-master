...
window.LECTURE_DATA.wlevel_1 = [
  ...
  },
  {
    ...
    captionKo: '초보자분들이 가장 먼저 배우는 아침 인사, 「おはよう(오하요-)」는 원래 「일찍 일어났다, 빠르다」는 의미예요. 즉, "오늘 참 일찍 일어났군요 부지런하네요!" 하고 칭찬하던 문화가 아침 인사로 굳어진 거랍니다.'
  },
  {
    ...
    captionKo: '일본어는 상대방이 누구냐에 따라 정중체(존댓말)와 반말(캐주얼)을 아주 엄격하게 구분해요. 친구에겐 편하게 「おはよう！」라고 하지만, 처음 만난 사람이나 직장에서는 뒤에 「ございます(고자이마스)」를 꼭! 붙여야 예의 바른 느낌을 줍니다.'
  },
  {
    ...
    captionKo: '한자에는 뜻으로 읽는 \'훈독\'과 소리로 읽는 \'음독\'이 있어요. 빠를 조(早) 자는 \'일찍\'이라는 뜻의 「はや(い)」로도 읽고, 다른 한자와 결합할 땐 「ソウ(소-)」라고 음으로도 읽어요. (예: 早朝: 소-쵸- / 이른 아침)'
  },
  {
    ...
    captionKo: '점심 인사로 배우는 「こんにちは(곤니치와)」. 맨 끝 글자는 왜 \'하\'인데 \'와\'라고 읽을까요? 사실 이건 단어가 아니라 문장이었어요. "오늘(こんにち)은(は) 어떠신가요?"라는 문장의 앞부분만 남아서 굳어졌기 때문에, 조사 역할을 하는 \'와(は)\'라고 읽어야 맞습니다!'
  },
  {
    ...
    captionKo: '「すみません(스미마셍)」은 한자로 쓰면 \'해결이 안 됐다(済まない)\'라는 뜻이에요. 상대에게 폐를 끼쳤는데 내 마음고생이 아직 안 끝났다는 의미로, 정말 죄송하다는 일본인 특유의 배려가 담겨있죠.'
  },
  {
  ...
  },
  {
    ...
    captionKo: '「ありがとう(아리가토-)」는 한자로 \'有難い(유난히)\', 즉 "있기 어렵다"는 말이에요! "당신이 베풀어준 친절은 세상에 정말 존재하기 힘들 만큼 귀합니다!"라는 뜻이 담겨 있으니, 외우기도 쉽고 참 따뜻하죠?'
  },
  {
    type: 'kanji', label: '한자 파헤치기', duration: 8000, audio: null,
    ...
    captionKo: '어려울 난(難) 한자는 언뜻 보면 복잡하죠? 오른쪽 부분을 보면 『새 조(鳥)』라는 한자가 보일 거예요. 불이 났을 때 날아다니는 새조차도 도망가기 어렵다는 옛날 이야기에서 \'어려움/재난\'이라는 뜻이 생겼답니다.'
  },
  {
    ...
    captionKo: '직역하면 "잘 부탁합니다" 정도지만, 훨씬 더 많은 상황에서 써요! 처음 만난 사람에게 윙크하듯이 나를 잘 봐달라고 할 때, 업무를 맡길 때, 대화 마무리에... 무조건 매일매일 쓰는 마법의 문장(요로시쿠 오네가이시마스)이에요!'
  },
  {
    ...
    captionKo: '첫 번째 강의 스터디 완료! 오늘은 아침 인사가 왜 칭찬이었는지, 만능 단어 스미마셍의 매력은 무엇인지 알아봤어요. 1강 내용만 알아도 일본인 친구들과 기초적인 매너 대화가 가능해집니다!'
  }
];
