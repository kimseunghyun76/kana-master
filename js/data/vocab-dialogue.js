...
var VOCAB_ITEMS_DIALOGUE = [
  ...
  { id:'ap_1',  speaker:'B', japanese:'パスポートとご予約(よやく)確認(かくにん)書をお願いします。',  romaji:'pasupooto to goyoyaku kakuninsho wo onegai shimasu', korean:'여권과 예약 확인서 주세요.', english:'Your passport and booking confirmation, please.' },
  ...
  { id:'ap_6',  speaker:'A', japanese:'はい、一個あります。手荷物(にもつ)は機内に持ちます。', romaji:'hai, ikko arimasu. tenimotsu wa kinai ni mochimasu', korean:'네, 하나요. 기내 수하물은 가지고 탈게요.', english:'Yes, I have one. I\'ll keep my carry-on with me.' },
  { id:'ap_7',  speaker:'B', japanese:'重量(じゅうりょう)は23キロです。搭乗(とうじょう)ゲートは34番です。', romaji:'juuryou wa nijuusan kiro desu. toujourgeeto wa sanjuuyon ban desu', korean:'무게 23kg이에요. 탑승 게이트는 34번이에요.', english:'The weight is 23 kg. Your boarding gate is number 34.' },
  { id:'ap_8',  speaker:'A', japanese:'搭乗(とうじょう)時刻(じこく)は何時(なんじ)ですか？',                   romaji:'tojou jikoku wa nanji desu ka', korean:'탑승 시간이 언제예요?', english:'What time is boarding?' },
  ...
  { id:'ap_10', speaker:'A', japanese:'両替(りょうがえ)はどこでできますか？',                  romaji:'ryougae wa doko de dekimasu ka', korean:'환전은 어디서 할 수 있어요?', english:'Where can I exchange currency?' },
  { id:'ap_11', speaker:'B', japanese:'セキュリティ手前(てまえ)の左側(ひだりがわ)にございます。',      romaji:'sekyuriti temae no hidari gawa ni gozaimasu', korean:'보안검색대 앞 왼쪽에 있어요.', english:'It\'s on the left side before the security checkpoint.' },
  { id:'ap_12', speaker:'A', japanese:'ありがとうございます。税関(ぜいかん)と入国審査(しんさ)はどこですか？', romaji:'arigatou gozaimasu. zeikan to nyuukoku shinsa wa doko desu ka', korean:'감사해요. 세관이랑 입국심사는 어디예요?', english:'Thank you. Where are customs and immigration?' },
  { id:'ap_13', speaker:'B', japanese:'ゲートを通(とお)った先(さき)にございます。よいご旅行(りょこう)を！', romaji:'geeto wo tootta saki ni gozaimasu. yoi goryokou wo', korean:'게이트 지나서 있어요. 좋은 여행 되세요!', english:'They\'re just past the gate. Have a great trip!' },
  ...
  { id:'hd_2',  speaker:'B', japanese:'お名前(なまえ)をお願いします。',                   romaji:'onamae wo onegai shimasu', korean:'성함을 알려주시겠어요?', english:'May I have your name?' },
  { id:'hd_3',  speaker:'A', japanese:'キム・ジウンと申(もう)します。',                 romaji:'kimu jiun to moushimasu', korean:'김지운이라고 합니다.', english:'My name is Kim Ji-un.' },
  { id:'hd_4',  speaker:'B', japanese:'ご予約(よやく)確認(かくにん)しました。パスポートを拝見(はいけん)できますか？', romaji:'goyoyaku kakunin shimashita. pasupooto wo haiken dekimasu ka', korean:'예약 확인했어요. 여권 볼 수 있을까요?', english:'I\'ve confirmed your reservation. May I see your passport?' },
  { id:'hd_5',  speaker:'A', japanese:'こちらです。朝食(ちょうしょく)は付(つ)いていますか？',        romaji:'kochira desu. choushoku wa tsuite imasu ka', korean:'여기요. 조식 포함인가요?', english:'Here it is. Is breakfast included?' },
  { id:'hd_6',  speaker:'B', japanese:'はい、朝食(ちょうしょく)込みです。7時から10時まで1階(いっかい)です。', romaji:'hai, choushoku komi desu. shichiji kara juuji made ikkai desu', korean:'네, 조식 포함이에요. 7시~10시, 1층이에요.', english:'Yes, breakfast is included. It\'s from 7 to 10 on the first floor.' },
  ...
  { id:'hd_8',  speaker:'B', japanese:'お部屋のカードに書(か)いてあります。',         romaji:'oheya no kaado ni kaite arimasu', korean:'방 카드에 적혀 있어요.', english:'It\'s written on your room card.' },
  { id:'hd_9',  speaker:'A', japanese:'チェックアウトは何時(なんじ)ですか？',              romaji:'chekkuauto wa nanji desu ka', korean:'체크아웃은 몇 시예요?', english:'What time is check-out?' },
  ...
  { id:'sh1_b2', speaker:'B', japanese:'スーツケースにこです。あ、おもさはだいじょうぶかな…ドン・キホーテでかいすぎたかも。', romaji:'', korean:'캐리어 2개입니다. 아, 무게는 괜찮으려나… 돈키호테에서 너무 많이 샀을지도.', tip:'買いすぎる(かいすぎる) = 너무 많이 사다 / 〜かも = ~일지도' },
