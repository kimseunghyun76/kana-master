...
var VOCAB_ITEMS_S1S5 = [
  ...
  { id:'gr_namae',    japanese:'〜と申(もう)します',                                                   korean:'〜라고 합니다 (이름 소개)',            english:'My name is ~ (formal)',              tip:'丁寧(ていねい)な自己紹介(じこしょうかい)' },
  { id:'si_kara',     japanese:'〜からきました',              kanji:'〜から来(き)ました',              korean:'〜에서 왔어요',                        english:'I came from ~',                      tip:'かんこくからきました = 한국에서 왔어요' },
  { id:'si_sai',      japanese:'〜さいです',                  kanji:'〜歳(さい)です',                  korean:'〜살이에요',                           english:'I am ~ years old',                   tip:'にじゅうさいです = 20살이에요' },
  { id:'si_shigoto',  japanese:'〜のしごとをしています',      kanji:'〜の仕事(しごと)をしています',   korean:'〜 일을 하고 있어요',                  english:'I work as a ~',                      tip:'がくせいです = 학생이에요' },
  ...
  { id:'si_suki',     japanese:'〜がすきです',                kanji:'〜が好(す)きです',               korean:'〜를 좋아해요',                        english:'I like ~',                           tip:'アニメがすきです = 애니 좋아해요' },
