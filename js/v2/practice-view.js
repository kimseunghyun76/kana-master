...
window.createPracticeView = (ctx) => {
  ...
  const PRACTICE_BG = {
    kana: window.V3GameAssets?.home || 'images/lecture-scenes/kana-hiragana-study-desk.webp',
    vocab: window.V3GameAssets?.shop || 'images/lecture-scenes/wlevel3-calendar-time-study.webp',
    kanaQuiz: window.V3GameAssets?.transit || 'images/lecture-scenes/kana-katakana-loanword-cafe.webp',
