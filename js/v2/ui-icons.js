...
window.UIIcons = (() => {
  function svg(name, cls = '') {
    const icons = {
      ...
      download: `<svg viewBox="0 0 24 24" class="${cls}" aria-hidden="true"><path d="M12 4v9M8.5 9.5 12 13l3.5-3.5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/><path d="M5 17.5V20h14v-2.5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
      upload: `<svg viewBox="0 0 24 24" class="${cls}" aria-hidden="true"><path d="M12 13V4M8.5 7.5 12 4l3.5 3.5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/><path d="M5 17.5V20h14v-2.5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
