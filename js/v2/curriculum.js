...
const MODULES = [
  ...
  },
  {
    ...
    nameJp: '数字・日付・時間',
    icon: '🔢',
    desc: '숫자 묶음은 한눈에 정리하고, 강좌에서는 예약·시간 표현을 실전으로 익히기',
    xp: 350,
    unlockAfter: ['survival_pointing'],
    steps: [
      { type: 'lecture',    title: '🎬 불길한 숫자의 비밀', lectureKey: 'wlevel_2' },
      { type: 'vocab_learn', title: '가격·수량 실전 표현', categoryId: 'numbers_applied', limit: 10 },
      { type: 'vocab_learn', title: '날짜·시각 핵심 표현', categoryIds: ['date_basic', 'time_clock', 'num_dates'], limit: 16 },
      { type: 'vocab_learn', title: '일정·예약 실전 표현', categoryId: 'schedule_practical', limit: 8 },
      { type: 'vocab_quiz',  title: '숫자·시간 실전 퀴즈', categoryIds: ['numbers_applied','num_dates','date_basic','time_clock','schedule_practical'], limit: 30 },
    ],
    roleplay: {
      id: 'rp_schedule',
      name: '약속 잡기',
