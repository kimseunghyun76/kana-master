...
const MODULES = [
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'kana_learn', title: '둥근 글자: あ・お・め・ぬ', kanaType: 'hiragana', chars: ['あ','お','め','ぬ'], customLabel: '모양 비교' },
      { type: 'kana_learn', title: '헷갈림 세트: さ・き・ち・ら', kanaType: 'hiragana', chars: ['さ','き','ち','ら'], customLabel: '선 방향 기억' },
      { type: 'kana_learn', title: '행 리듬 1: あかさたな', kanaType: 'hiragana', chars: ['あ','か','さ','た','な'], customLabel: '첫 글자 지도' },
      { type: 'kana_learn', title: '행 리듬 2: はまやらわ', kanaType: 'hiragana', chars: ['は','ま','や','ら','わ'], customLabel: '두 번째 지도' },
      { type: 'kana_quiz', title: '히라가나 위치 퀴즈', kanaType: 'hiragana', chars: HIRAGANA_BASE },
      { type: 'kana_listening', title: '히라가나 소리 찾기', chars: HIRAGANA_BASE },
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'kana_learn', title: '가타가나 각진 글자 묶음', kanaType: 'katakana', chars: ['ア','カ','ケ','セ','テ','ト','ナ'], customLabel: '각진 모양' },
      { type: 'kana_learn', title: '헷갈림 세트: シ・ツ・ソ・ン', kanaType: 'katakana', chars: ['シ','ツ','ソ','ン'], customLabel: '점 방향 비교' },
      { type: 'kana_quiz', title: '간판 문자 퀴즈', kanaType: 'katakana', chars: KATAKANA_BASE },
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'kana_learn', title: '점이 붙으면 목소리가 탁해진다', kanaType: 'hiragana_dakuten', levelId: 6 },
      { type: 'kana_learn', title: '작은 やゆよ는 한 박자로 붙는다', kanaType: 'hiragana_yoon', levelId: 7 },
      { type: 'kana_learn', title: '장음·촉음·조사 はへを', kanaType: 'special', levelId: 15 },
