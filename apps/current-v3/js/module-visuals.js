...
window.ModuleVisuals = (() => {
  // Asset map. Each key resolves to one of ~12 distinct background files
  // so neighbouring modules don't all share the same picture.
  const FILE = {
    homeStreet:    'images/v3-generated/bg-home-street.webp',
    sakuraStreet:  'images/v3-cute/home-sakura-street.webp',
    station:       'images/v3-generated/bg-station.webp',
    stationPastel: 'images/v3-cute/bg-station-pastel.webp',
    airportPastel: 'images/v3-cute/bg-airport-pastel.webp',
    airportComic:  'images/roleplay-comics/generated/v3-airport-bg.png',
    transitComic:  'images/roleplay-comics/generated/v3-transit-bg.png',
    shopCafe:      'images/v3-generated/bg-shop-cafe.webp',
    shopPastel:    'images/v3-cute/bg-shop-cafe-pastel.webp',
    foodComic:     'images/roleplay-comics/generated/v3-food-bg.png',
    shopComic:     'images/roleplay-comics/generated/v3-shop-bg.png',
    hotelRyokan:   'images/v3-generated/bg-hotel-ryokan.webp',
    hotelPastel:   'images/v3-cute/bg-hotel-ryokan-pastel.webp',
    onsenComic:    'images/roleplay-comics/generated/v3-hotel-onsen-bg.png',
    pharmacy:      'images/v3-cute/bg-pharmacy-clinic-pastel.webp',
    health:        'images/roleplay-comics/generated/v3-health-trouble-bg.png',
    localTravel:   'images/roleplay-comics/generated/v3-local-travel-bg.png',
    mapHelp:       'images/v3-generated/roleplay-map-help.webp',
  };

  // Semantic alias layer kept for back-compat with existing keys.
  window.V3GameAssets = {
    home:            FILE.sakuraStreet,
    airport:         FILE.airportPastel,
    airportScene:    FILE.airportComic,
    transit:         FILE.stationPastel,
    transitScene:    FILE.transitComic,
    stationTransfer: FILE.station,
    stationHelp:     FILE.station,
    shop:            FILE.shopPastel,
    shopScene:       FILE.shopComic,
    food:            FILE.foodComic,
    foodScene:       FILE.shopCafe,
    hotel:           FILE.hotelPastel,
    hotelScene:      FILE.hotelRyokan,
    trouble:         FILE.pharmacy,
    troubleScene:    FILE.health,
    local:           FILE.sakuraStreet,
    localScene:      FILE.localTravel,
    kanaDesk:        FILE.sakuraStreet,
    katakanaCafe:    FILE.shopPastel,
    greetingClass:   FILE.homeStreet,
    mapHelp:         FILE.mapHelp,
    introLobby:      FILE.sakuraStreet,
    konbini:         FILE.shopCafe,
    ryokanLobby:     FILE.hotelPastel,
    kobanHelp:       FILE.localTravel,
    sightseeing:     FILE.localTravel,
    counter:         FILE.shopCafe,
    calendar:        FILE.homeStreet,
    cityDirections:  FILE.mapHelp,
    dining:          FILE.foodComic,
    cafeCompare:     FILE.shopPastel,
    izakaya:         FILE.foodComic,
    cafeOrder:       FILE.shopCafe,
    hotelFront:      FILE.hotelRyokan,
    clinic:          FILE.health,
  };
