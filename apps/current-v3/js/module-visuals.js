...
window.ModuleVisuals = (() => {
  window.V3GameAssets = {
    home: 'images/v3-cute/bg-tourist-street-cute.webp',
    ...
    kanaDesk: 'images/v3-cute/bg-tourist-street-cute.webp',
    katakanaCafe: 'images/v3-cute/bg-cafe-restaurant-cute.webp',
    greetingClass: 'images/v3-cute/bg-tourist-street-cute.webp',
    mapHelp: 'images/v3-cute/bg-tourist-street-cute.webp',
    introLobby: 'images/v3-cute/bg-tourist-street-cute.webp',
    stationTransfer: 'images/v3-cute/bg-station-platform-cute.webp',
    ryokanLobby: 'images/v3-cute/bg-hotel-lobby-cute.webp',
    kobanHelp: 'images/v3-cute/bg-pharmacy-clinic-cute.webp',
    sightseeing: 'images/v3-cute/bg-tourist-street-cute.webp',
    counter: 'images/v3-cute/bg-konbini-checkout-cute.webp',
    calendar: 'images/v3-cute/bg-tourist-street-cute.webp',
    cityDirections: 'images/v3-cute/bg-tourist-street-cute.webp',
    stationHelp: 'images/v3-cute/bg-station-platform-cute.webp',
    dining: 'images/v3-cute/bg-cafe-restaurant-cute.webp',
    cafeCompare: 'images/v3-cute/bg-cafe-restaurant-cute.webp',
    cafeOrder: 'images/v3-cute/bg-cafe-restaurant-cute.webp',
    hotelFront: 'images/v3-cute/bg-hotel-lobby-cute.webp',
    clinic: 'images/v3-cute/bg-pharmacy-clinic-cute.webp',
    foodScene: 'images/v3-cute/bg-cafe-restaurant-cute.webp',
    localScene: 'images/v3-cute/bg-tourist-street-cute.webp',
    transitScene: 'images/v3-cute/bg-station-platform-cute.webp',
    airportScene: 'images/v3-cute/bg-airport-checkin-cute.webp',
    shopScene: 'images/v3-cute/bg-clothing-store-cute.webp',
    hotelScene: 'images/v3-cute/bg-hotel-lobby-cute.webp',
    troubleScene: 'images/v3-cute/bg-pharmacy-clinic-cute.webp',
  };
